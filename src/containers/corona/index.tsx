...
export default class Corona extends React.Component<Props>{
    ...
    render() {
        const { summary, countriesOptions, countriesFiltered, countryCode, handleForm } = this.props.corona;
                ...
                <Grid>
                    ...
                    <Grid.Row>
                        <Card.Group itemsPerRow={countryCode ? 1 : 3}>
                            {/* Sempre que for fazer um map, o filho precisa de um atributo key */}
