        ...
        <Form>
          <Form.Group widths='equal'>
            <Form.Field>
              ...
              <input value={zipcode || ''} maxLength={8} name='zipcode' onChange={handleForm} placeholder='Ex: 14400350' />
            </Form.Field>
            <Form.Field>
              <Cep zipCode={zipcode} />
            </Form.Field>
          ...
          <Form.Group widths='equal'>
            <Form.Field>
              ...
              <input value={github || ''} maxLength={50} name='github' onChange={handleForm} placeholder='Ex: lonerpatti' />
            </Form.Field>
            <Form.Field>
